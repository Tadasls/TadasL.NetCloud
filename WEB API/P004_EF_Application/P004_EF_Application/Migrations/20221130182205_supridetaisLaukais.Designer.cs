...
namespace P004EFApplication.Migrations
{
    ...
    [Migration("20221130182205_supridetaisLaukais")]
    partial class supridetaisLaukais
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("P004_EF_Application.Models.Dish", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            DishId = 1,
                            Country = "Lithuania",
                            CreatedDateTime = new DateTime(2022, 11, 30, 20, 22, 5, 352, DateTimeKind.Local).AddTicks(953),
                            ImagePath = "",
                        ...
                        new
                        {
                            DishId = 2,
                            Country = "Lithuania",
                            CreatedDateTime = new DateTime(2022, 11, 30, 20, 22, 5, 352, DateTimeKind.Local).AddTicks(990),
                            ImagePath = "",
                        ...
                        new
                        {
                            DishId = 3,
                            Country = "Lithuania",
                            CreatedDateTime = new DateTime(2022, 11, 30, 20, 22, 5, 352, DateTimeKind.Local).AddTicks(993),
                            ImagePath = "",
                            Name = "Kibinai",
                            SpiceLevel = "low",
                            Type = "Street Food",
