            ...
            modelBuilder.Entity("P004_EF_Application.Models.Dish", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            DishId = 1,
                            Country = "Lithuania",
                            CreateDateTime = new DateTime(2022, 12, 22, 14, 39, 7, 18, DateTimeKind.Local).AddTicks(7390),
                            ImagePath = "",
                        ...
                        new
                        {
                            DishId = 2,
                            Country = "Lithuania",
                            CreateDateTime = new DateTime(2022, 12, 22, 14, 39, 7, 18, DateTimeKind.Local).AddTicks(7425),
                            ImagePath = "",
                        ...
                        new
                        {
                            DishId = 3,
                            Country = "Lithuania",
                            CreateDateTime = new DateTime(2022, 12, 22, 14, 39, 7, 18, DateTimeKind.Local).AddTicks(7427),
                            ImagePath = "",
                            Name = "Kibinai",
                            SpiceLevel = "low",
                            Type = "Street Food",
