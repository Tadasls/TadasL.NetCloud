        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
         ...
         .HasKey(d => d.Id);
            ...
            .HasData(
                ...
                new Book(7, "Scouting for Boys", "Robert Baden-Powell", ECoverType.Paperback, 1908, 1, DateTime.Now, EBookStatus.WishListed),
                new Book(8, "And Then There Were None", "Agatha Christie", ECoverType.Paperback, 1939, 1, DateTime.Now, EBookStatus.WishListed),
                new Book(9, "The Hobbit", "John Tolkien ", ECoverType.Hardcover, 1937, 1, DateTime.Now, EBookStatus.WishListed),
                new Book(10, "The Dream Of The Red Chambe", "Cao Xueqin", ECoverType.Paperback, 1791, 1, DateTime.Now, EBookStatus.WishListed)
                );
