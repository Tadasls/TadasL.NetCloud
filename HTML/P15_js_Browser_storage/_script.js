...
function puslapioValidacija() {
    confirm("Ar  sutinkate su salygomis?") === true
          ? sessionStorage.setItem('usserio_Sutikimas', true )
          : alert("Nieko neivyko");
};
// puslapioValidacija();

f_name2.addEventListener('keyup', () => {
  tekstuiVaizduoti.innerHTML = f_name2.value;
});
