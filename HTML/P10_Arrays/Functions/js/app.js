...
function ConvToFar(kelvinai){
    return(((kelvinai-273.15)*1.8)+32);
 }
console.log(ConvToFar(50).toFixed(2));
console.log(ConvToFar(20).toFixed(2));


function KOnvToKelv(farenheitai){
    return( 5/9 *(farenheitai-32));
 }
