    ...
    public class Program
    {
        ...
        public static void DictionaryPavyzdziai()
        {
            ...
            Dictionary<string, List<int>> zaidejuTaskuZodynas = new Dictionary<string, List<int>>()
            {
                ...
                {"Adas", new List<int>(){9,7,10 } },
                {"Mitas", new List<int>(){9,8,9 } }
      ...
      /*  KLASES DARBAS 1.
       *  ## Parasykite metoda, kuris priima sveikaji skaiciu kaip parametra 
       *  ir sukuria nauja zodyna - raktas:x, reiksme:x*x formoje.
       ...
       */
        ...
        public static void AtspausdintiPirmaKlasesDarba()
        {
            ...
            {
                Console.WriteLine($"{skaicius.Key}:{skaicius.Value}");
            }
        }
