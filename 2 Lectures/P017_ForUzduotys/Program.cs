...
namespace P017_ForUzduotys
{
    public class Program
    {
        ...
        public static int Skaiciuotuvas()
        {
            int sk1 = 0;
            int sk2 = 0;
        ...
        public static int SudetiSkaicius(int sk1, int sk2)
        {
            return sk1 + sk2;
        }
        public static int AtimtiSkaicius(int sk1, int sk2)
        {
            return sk1 - sk2;
        }
        ...
        public static double DalintiSkaicius(int sk1, int sk2)
        {
            return (double)sk1 / sk2;
        }
        public static int LaipsniuKelimoSkaicius(int sk1)
        {
                int valSqr = 0;
        ...
        public static double SakniesTraukimoSkaicius(int sk1)
        {    
            double root = 1;
            int i = 0;
