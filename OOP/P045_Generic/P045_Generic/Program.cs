...
namespace P045_Generics
{
    internal class Program
    {
        ...
        */
        ...
        /*
         Uzduotis 3
        Pries uzduotis susikurti 3 klases: PrivateClient, Administrator, BusinessClient. Visos jos paveldeja is interface IUser (int Id get set, string Name get set, )
        Sukurti generic <EntityRepository> klase, kuri priimtu klases su tusciu konstruktoriumi duomenu tipa ir turetu metodus: Add, Remove, Print(), Fetch(). 
