using HW03_WarehouseRental.Domains.Interfaces;
...
{
    public class WareHouseDbManager : IDbManager
    {
        ...
        public void RegisterWareHouseRent(int customerId, int salePersonId, int inventorySize, decimal price)
        {
            throw new NotImplementedException();
        }
    }
